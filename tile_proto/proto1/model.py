...
class Base_cell(_object):
    ...
    __repr__ = _swig_repr
    def msum(self):
        """msum(Base_cell self) -> vctr3"""
        return _model.Base_cell_msum(self)
...
class Cell2(Base_cell):
    """Proxy of C++ Cell2 class"""
    __swig_setmethods__ = {}
    for _s in [Base_cell]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, Cell2, name, value)
    __swig_getmethods__ = {}
    for _s in [Base_cell]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
    __getattr__ = lambda self, name: _swig_getattr(self, Cell2, name)
    def __init__(self, *args, **kwargs): raise AttributeError("No constructor defined - class is abstract")
    __repr__ = _swig_repr
    __swig_setmethods__["m1"] = _model.Cell2_m1_set
    __swig_getmethods__["m1"] = _model.Cell2_m1_get
    if _newclass:m1 = _swig_property(_model.Cell2_m1_get, _model.Cell2_m1_set)
    __swig_setmethods__["H1"] = _model.Cell2_H1_set
    __swig_getmethods__["H1"] = _model.Cell2_H1_get
    if _newclass:H1 = _swig_property(_model.Cell2_H1_get, _model.Cell2_H1_set)
    __swig_setmethods__["m2"] = _model.Cell2_m2_set
    __swig_getmethods__["m2"] = _model.Cell2_m2_get
    if _newclass:m2 = _swig_property(_model.Cell2_m2_get, _model.Cell2_m2_set)
    __swig_setmethods__["H2"] = _model.Cell2_H2_set
    __swig_getmethods__["H2"] = _model.Cell2_H2_get
    if _newclass:H2 = _swig_property(_model.Cell2_H2_get, _model.Cell2_H2_set)
    __swig_destroy__ = _model.delete_Cell2
    __del__ = lambda self : None;
Cell2_swigregister = _model.Cell2_swigregister
Cell2_swigregister(Cell2)
...
class Base_tile(_object):
    ...
    def __init__(self, *args, **kwargs): raise AttributeError("No constructor defined - class is abstract")
    __repr__ = _swig_repr
    __swig_setmethods__["J"] = _model.Base_tile_J_set
    __swig_getmethods__["J"] = _model.Base_tile_J_get
    if _newclass:J = _swig_property(_model.Base_tile_J_get, _model.Base_tile_J_set)
    __swig_setmethods__["H_ext"] = _model.Base_tile_H_ext_set
    __swig_getmethods__["H_ext"] = _model.Base_tile_H_ext_get
    if _newclass:H_ext = _swig_property(_model.Base_tile_H_ext_get, _model.Base_tile_H_ext_set)
    __swig_setmethods__["h"] = _model.Base_tile_h_set
    __swig_getmethods__["h"] = _model.Base_tile_h_get
    if _newclass:h = _swig_property(_model.Base_tile_h_get, _model.Base_tile_h_set)
    __swig_setmethods__["gamma"] = _model.Base_tile_gamma_set
    __swig_getmethods__["gamma"] = _model.Base_tile_gamma_get
    if _newclass:gamma = _swig_property(_model.Base_tile_gamma_get, _model.Base_tile_gamma_set)
    __swig_setmethods__["alpha"] = _model.Base_tile_alpha_set
    __swig_getmethods__["alpha"] = _model.Base_tile_alpha_get
    if _newclass:alpha = _swig_property(_model.Base_tile_alpha_get, _model.Base_tile_alpha_set)
    ...
    __swig_setmethods__["m_init"] = _model.Base_tile_m_init_set
    __swig_getmethods__["m_init"] = _model.Base_tile_m_init_get
    if _newclass:m_init = _swig_property(_model.Base_tile_m_init_get, _model.Base_tile_m_init_set)
    __swig_setmethods__["m1_init"] = _model.Base_tile_m1_init_set
    __swig_getmethods__["m1_init"] = _model.Base_tile_m1_init_get
    if _newclass:m1_init = _swig_property(_model.Base_tile_m1_init_get, _model.Base_tile_m1_init_set)
    __swig_setmethods__["m2_init"] = _model.Base_tile_m2_init_set
    __swig_getmethods__["m2_init"] = _model.Base_tile_m2_init_get
    if _newclass:m2_init = _swig_property(_model.Base_tile_m2_init_get, _model.Base_tile_m2_init_set)
    def start(self):
    ...
    def step_H(self, *args):
        """
        step_H(Base_tile self, Base_tile mmm, Base_tile zmm, Base_tile pmm, Base_tile pzm, Base_tile ppm, Base_tile zpm, 
            Base_tile mpm, Base_tile mzm, Base_tile mmz, Base_tile zmz, Base_tile pmz, 
            Base_tile pzz, Base_tile ppz, Base_tile zpz, Base_tile mpz, Base_tile mzz, 
            Base_tile mmp, Base_tile zmp, Base_tile pmp, Base_tile pzp, Base_tile ppp, 
            Base_tile zpp, Base_tile mpp, Base_tile mzp, Base_tile zzm, Base_tile zzp)
        """
...
class Sec1_tale(Base_tile):
    """Proxy of C++ Sec1_tale class"""
    __swig_setmethods__ = {}
    for _s in [Base_tile]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, Sec1_tale, name, value)
    __swig_getmethods__ = {}
    for _s in [Base_tile]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
    __getattr__ = lambda self, name: _swig_getattr(self, Sec1_tale, name)
    __repr__ = _swig_repr
    def start(self):
        """start(Sec1_tale self)"""
        return _model.Sec1_tale_start(self)

    def step_H(self, *args):
        """
        step_H(Sec1_tale self, Base_tile mmm, Base_tile zmm, Base_tile pmm, Base_tile pzm, Base_tile ppm, Base_tile zpm, 
            Base_tile mpm, Base_tile mzm, Base_tile mmz, Base_tile zmz, Base_tile pmz, 
            Base_tile pzz, Base_tile ppz, Base_tile zpz, Base_tile mpz, Base_tile mzz, 
            Base_tile mmp, Base_tile zmp, Base_tile pmp, Base_tile pzp, Base_tile ppp, 
            Base_tile zpp, Base_tile mpp, Base_tile mzp, Base_tile zzm, Base_tile zzp)
        """
        return _model.Sec1_tale_step_H(self, *args)

    def step_m(self):
        """step_m(Sec1_tale self)"""
        return _model.Sec1_tale_step_m(self)

    def __init__(self): 
        """__init__(Sec1_tale self) -> Sec1_tale"""
        this = _model.new_Sec1_tale()
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _model.delete_Sec1_tale
    __del__ = lambda self : None;
Sec1_tale_swigregister = _model.Sec1_tale_swigregister
Sec1_tale_swigregister(Sec1_tale)

class Sec3_tale(Base_tile):
    """Proxy of C++ Sec3_tale class"""
    __swig_setmethods__ = {}
    for _s in [Base_tile]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, Sec3_tale, name, value)
    __swig_getmethods__ = {}
    for _s in [Base_tile]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
    __getattr__ = lambda self, name: _swig_getattr(self, Sec3_tale, name)
    __repr__ = _swig_repr
    def start(self):
        """start(Sec3_tale self)"""
        return _model.Sec3_tale_start(self)

    def step_H(self, *args):
        """
        step_H(Sec3_tale self, Base_tile mmm, Base_tile zmm, Base_tile pmm, Base_tile pzm, Base_tile ppm, Base_tile zpm, 
            Base_tile mpm, Base_tile mzm, Base_tile mmz, Base_tile zmz, Base_tile pmz, 
            Base_tile pzz, Base_tile ppz, Base_tile zpz, Base_tile mpz, Base_tile mzz, 
            Base_tile mmp, Base_tile zmp, Base_tile pmp, Base_tile pzp, Base_tile ppp, 
            Base_tile zpp, Base_tile mpp, Base_tile mzp, Base_tile zzm, Base_tile zzp)
        """
        return _model.Sec3_tale_step_H(self, *args)

    def step_m(self):
        """step_m(Sec3_tale self)"""
        return _model.Sec3_tale_step_m(self)

    def __init__(self): 
        """__init__(Sec3_tale self) -> Sec3_tale"""
        this = _model.new_Sec3_tale()
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _model.delete_Sec3_tale
    __del__ = lambda self : None;
Sec3_tale_swigregister = _model.Sec3_tale_swigregister
Sec3_tale_swigregister(Sec3_tale)

class Sec2_tale(Base_tile):
    """Proxy of C++ Sec2_tale class"""
    __swig_setmethods__ = {}
    for _s in [Base_tile]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, Sec2_tale, name, value)
    __swig_getmethods__ = {}
    for _s in [Base_tile]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
    __getattr__ = lambda self, name: _swig_getattr(self, Sec2_tale, name)
    __repr__ = _swig_repr
    def start(self):
        """start(Sec2_tale self)"""
        return _model.Sec2_tale_start(self)

    def step_H(self, *args):
        """
        step_H(Sec2_tale self, Base_tile mmm, Base_tile zmm, Base_tile pmm, Base_tile pzm, Base_tile ppm, Base_tile zpm, 
            Base_tile mpm, Base_tile mzm, Base_tile mmz, Base_tile zmz, Base_tile pmz, 
            Base_tile pzz, Base_tile ppz, Base_tile zpz, Base_tile mpz, Base_tile mzz, 
            Base_tile mmp, Base_tile zmp, Base_tile pmp, Base_tile pzp, Base_tile ppp, 
            Base_tile zpp, Base_tile mpp, Base_tile mzp, Base_tile zzm, Base_tile zzp)
        """
        return _model.Sec2_tale_step_H(self, *args)

    def step_m(self):
        """step_m(Sec2_tale self)"""
        return _model.Sec2_tale_step_m(self)

    def __init__(self): 
        """__init__(Sec2_tale self) -> Sec2_tale"""
        this = _model.new_Sec2_tale()
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _model.delete_Sec2_tale
    __del__ = lambda self : None;
Sec2_tale_swigregister = _model.Sec2_tale_swigregister
Sec2_tale_swigregister(Sec2_tale)
