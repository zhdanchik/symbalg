...
%include "aivlib/meshTD.hpp"
%include "aivlib/multiarrayT.hpp"
%template(arrPT3) aiv::array<ptile,3>; %template(meshPT3) aiv::mesh<ptile,3>; %template(mult_arrPT3) aiv::multiarray< aiv::array<ptile,3> >;
%pythoncode %{arrPT3.__setstate__, meshPT3.__setstate__ = _setstate, _setstate %}
%template(splice1) aiv::splice<1,ptile,3>;
%template(splice2) aiv::splice<2,ptile,3>;
...
%include "aivlib/meshTD.hpp"
%include "aivlib/multiarrayT.hpp"
%template(arrPC3) aiv::array<pcell,3>; %template(meshPC3) aiv::mesh<pcell,3>; %template(mult_arrPC3) aiv::multiarray< aiv::array<pcell,3> >;
%pythoncode %{arrPC3.__setstate__, meshPC3.__setstate__ = _setstate, _setstate %}
%template(splice1) aiv::splice<1,pcell,3>;
%template(splice2) aiv::splice<2,pcell,3>;
%pythoncode %{from aivlib.vctr3 import * %}
%pythoncode %{from aivlib.mystream import * %}
%pythoncode%{ from aivlib.mystream import *; %}
