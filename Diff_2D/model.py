...
class cell(_object):
    ...
    __repr__ = _swig_repr
    __swig_setmethods__["g"] = _model.cell_g_set
    __swig_getmethods__["g"] = _model.cell_g_get
    if _newclass:g = _swig_property(_model.cell_g_get, _model.cell_g_set)
    __swig_setmethods__["f"] = _model.cell_f_set
    __swig_getmethods__["f"] = _model.cell_f_get
    if _newclass:f = _swig_property(_model.cell_f_get, _model.cell_f_set)
    def __init__(self): 
...
class Model(_object):
    ...
    __swig_setmethods__["D"] = _model.Model_D_set
    __swig_getmethods__["D"] = _model.Model_D_get
    if _newclass:D = _swig_property(_model.Model_D_get, _model.Model_D_set)
    ...
    __swig_setmethods__["dy"] = _model.Model_dy_set
    __swig_getmethods__["dy"] = _model.Model_dy_get
    if _newclass:dy = _swig_property(_model.Model_dy_get, _model.Model_dy_set)
    def start(self, *args):
        """start(Model self, aiv::indx< 2 > offset)"""
        return _model.Model_start(self, *args)

    def start_delta(self, *args):
        """start_delta(Model self, aiv::indx< 2 > offset)"""
        return _model.Model_start_delta(self, *args)
