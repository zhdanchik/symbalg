...
class part(_object):
    ...
    __repr__ = _swig_repr
    __swig_setmethods__["m"] = _model.part_m_set
    __swig_getmethods__["m"] = _model.part_m_get
    if _newclass:m = _swig_property(_model.part_m_get, _model.part_m_set)
    def __init__(self): 
...
class Model(_object):
    ...
    __swig_setmethods__["k"] = _model.Model_k_set
    __swig_getmethods__["k"] = _model.Model_k_get
    if _newclass:k = _swig_property(_model.Model_k_get, _model.Model_k_set)
    ...
    __swig_setmethods__["rand_alpha2PI"] = _model.Model_rand_alpha2PI_set
    __swig_getmethods__["rand_alpha2PI"] = _model.Model_rand_alpha2PI_get
    if _newclass:rand_alpha2PI = _swig_property(_model.Model_rand_alpha2PI_get, _model.Model_rand_alpha2PI_set)
    __swig_setmethods__["abs"] = _model.Model_abs_set
    __swig_getmethods__["abs"] = _model.Model_abs_get
    if _newclass:abs = _swig_property(_model.Model_abs_get, _model.Model_abs_set)
    ...
    __swig_setmethods__["One"] = _model.Model_One_set
    __swig_getmethods__["One"] = _model.Model_One_get
    if _newclass:One = _swig_property(_model.Model_One_get, _model.Model_One_set)
    ...
    __swig_setmethods__["M1"] = _model.Model_M1_set
    __swig_getmethods__["M1"] = _model.Model_M1_get
    if _newclass:M1 = _swig_property(_model.Model_M1_get, _model.Model_M1_set)
    __swig_setmethods__["M2"] = _model.Model_M2_set
    __swig_getmethods__["M2"] = _model.Model_M2_get
    if _newclass:M2 = _swig_property(_model.Model_M2_get, _model.Model_M2_set)
    def calc(self):
        """calc(Model self)"""
