...
class cell(_object):
    ...
    __repr__ = _swig_repr
    __swig_setmethods__["H"] = _model.cell_H_set
    __swig_getmethods__["H"] = _model.cell_H_get
    if _newclass:H = _swig_property(_model.cell_H_get, _model.cell_H_set)
    __swig_setmethods__["m"] = _model.cell_m_set
    __swig_getmethods__["m"] = _model.cell_m_get
    if _newclass:m = _swig_property(_model.cell_m_get, _model.cell_m_set)
    def __init__(self): 
...
class Model(_object):
    ...
    __swig_setmethods__["Init_m"] = _model.Model_Init_m_set
    __swig_getmethods__["Init_m"] = _model.Model_Init_m_get
    if _newclass:Init_m = _swig_property(_model.Model_Init_m_get, _model.Model_Init_m_set)
    ...
    __swig_setmethods__["M1m"] = _model.Model_M1m_set
    __swig_getmethods__["M1m"] = _model.Model_M1m_get
    if _newclass:M1m = _swig_property(_model.Model_M1m_get, _model.Model_M1m_set)
    def start(self, *args):
        """start(Model self, indx3 offset)"""
        return _model.Model_start(self, *args)

    def calc_means(self):
        """calc_means(Model self)"""
        return _model.Model_calc_means(self)

    def calc_cone_all(self, *args):
        """calc_cone_all(Model self, double init_time, indx3 offset)"""
        return _model.Model_calc_cone_all(self, *args)
