...
%include "aivlib/meshTD.hpp"
%include "aivlib/multiarrayT.hpp"
%template(arrC3) aiv::array<cell,3>; %template(meshC3) aiv::mesh<cell,3>; %template(mult_arrC3) aiv::multiarray< aiv::array<cell,3> >;
%pythoncode %{arrC3.__setstate__, meshC3.__setstate__ = _setstate, _setstate %}
%template(splice1) aiv::splice<1,cell,3>;
%template(splice2) aiv::splice<2,cell,3>;
