...
%include "aivlib/meshTD.hpp"
%include "aivlib/multiarrayT.hpp"
%template(arrC1) aiv::array<cell,1>; %template(meshC1) aiv::mesh<cell,1>; %template(mult_arrC1) aiv::multiarray< aiv::array<cell,1> >;
%pythoncode %{arrC1.__setstate__, meshC1.__setstate__ = _setstate, _setstate %}
