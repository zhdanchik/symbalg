...
class cell(_object):
    ...
    __repr__ = _swig_repr
    __swig_setmethods__["B"] = _model.cell_B_set
    __swig_getmethods__["B"] = _model.cell_B_get
    if _newclass:B = _swig_property(_model.cell_B_get, _model.cell_B_set)
    __swig_setmethods__["E"] = _model.cell_E_set
    __swig_getmethods__["E"] = _model.cell_E_get
    if _newclass:E = _swig_property(_model.cell_E_get, _model.cell_E_set)
    def __init__(self): 
...
class Model(_object):
    ...
    __swig_setmethods__["C2"] = _model.Model_C2_set
    __swig_getmethods__["C2"] = _model.Model_C2_get
    if _newclass:C2 = _swig_property(_model.Model_C2_get, _model.Model_C2_set)
    __swig_setmethods__["C1"] = _model.Model_C1_set
    __swig_getmethods__["C1"] = _model.Model_C1_get
    if _newclass:C1 = _swig_property(_model.Model_C1_get, _model.Model_C1_set)
    __swig_setmethods__["C0"] = _model.Model_C0_set
    __swig_getmethods__["C0"] = _model.Model_C0_get
    if _newclass:C0 = _swig_property(_model.Model_C0_get, _model.Model_C0_set)
    ...
    def start(self, *args):
        """start(Model self, indx1 offset)"""
        return _model.Model_start(self, *args)

    def calc_cone_1(self, *args):
        """calc_cone_1(Model self, double init_time, indx1 offset)"""
...
class arrC1(_object):
    """Proxy of C++ aiv::array<(cell,1)> class"""
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, arrC1, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, arrC1, name)
    __repr__ = _swig_repr
    dim = _model.arrC1_dim
    dump_dim = _model.arrC1_dump_dim
    __swig_getmethods__["N"] = _model.arrC1_N_get
    if _newclass:N = _swig_property(_model.arrC1_N_get)
    def clean(self):
        """clean(arrC1 self)"""
        return _model.arrC1_clean(self)

    def init(self, *args):
        """init(arrC1 self, indx1 AN)"""
        return _model.arrC1_init(self, *args)

    def mmap(self, *args):
        """
        mmap(arrC1 self, indx1 AN, char const * fname, long offset, bool write=False)
        mmap(arrC1 self, indx1 AN, char const * fname, long offset)
        """
        return _model.arrC1_mmap(self, *args)

    def info(self, *args):
        """
        info(arrC1 self, aiv::Ostream & S=mystdout)
        info(arrC1 self)
        """
        return _model.arrC1_info(self, *args)

    def solid_dims(self):
        """solid_dims(arrC1 self) -> int"""
        return _model.arrC1_solid_dims(self)

    def nb_shift(self, *args):
        """nb_shift(arrC1 self, int pos, int axe) -> long"""
        return _model.arrC1_nb_shift(self, *args)

    def index(self, *args):
        """
        index(arrC1 self, indx1 I) -> long
        index(arrC1 self, long i) -> long
        """
        return _model.arrC1_index(self, *args)

    def get(self, *args):
        """
        get(arrC1 self, long i) -> cell
        get(arrC1 self, long i) -> cell
        """
        return _model.arrC1_get(self, *args)

    __swig_destroy__ = _model.delete_arrC1
    __del__ = lambda self : None;
    def copy(self):
        """copy(arrC1 self) -> arrC1"""
        return _model.arrC1_copy(self)

    def crop(self, *args):
        """
        crop(arrC1 self, indx1 a, indx1 b, indx1 step=aiv::indx(1)) -> arrC1
        crop(arrC1 self, indx1 a, indx1 b) -> arrC1
        """
        return _model.arrC1_crop(self, *args)

    def swap(self, *args):
        """swap(arrC1 self, int i, int j) -> arrC1"""
        return _model.arrC1_swap(self, *args)

    def flip(self, *args):
        """flip(arrC1 self, int i) -> arrC1"""
        return _model.arrC1_flip(self, *args)

    def __len__(self):
        """__len__(arrC1 self) -> int"""
        return _model.arrC1___len__(self)

    def __getitem__(self, *args):
        """
        __getitem__(arrC1 self, indx1 I) -> cell
        __getitem__(arrC1 self, long I) -> cell
        __getitem__(arrC1 self, PyObject * t) -> cell
        """
        return _model.arrC1___getitem__(self, *args)

    def __setitem__(self, *args):
        """
        __setitem__(arrC1 self, indx1 I, cell val)
        __setitem__(arrC1 self, long I, cell val)
        __setitem__(arrC1 self, PyObject * t, cell val)
        """
        return _model.arrC1___setitem__(self, *args)

    def __getstate__(self):
        """__getstate__(arrC1 self) -> PyObject *"""
        return _model.arrC1___getstate__(self)

    def __C_setstate__(self, *args):
        """__C_setstate__(arrC1 self, PyObject * t)"""
        return _model.arrC1___C_setstate__(self, *args)

    def dump(self, *args):
        """
        dump(arrC1 self, aiv::Ostream & S, char const * header=None)
        dump(arrC1 self, aiv::Ostream & S)
        """
        return _model.arrC1_dump(self, *args)

    def update(self, *args):
        """
        update(arrC1 self, aiv::Istream & S, indx1 a=aiv::indx(), indx1 b=aiv::indx(), indx1 step=aiv::indx(1), 
        ...
        update(arrC1 self, aiv::Istream & S, indx1 a=aiv::indx(), indx1 b=aiv::indx(), indx1 step=aiv::indx(1), 
            int * pos=None) -> indx1
        update(arrC1 self, aiv::Istream & S, indx1 a=aiv::indx(), indx1 b=aiv::indx(), indx1 step=aiv::indx(1)) -> indx1
        update(arrC1 self, aiv::Istream & S, indx1 a=aiv::indx(), indx1 b=aiv::indx()) -> indx1
        update(arrC1 self, aiv::Istream & S, indx1 a=aiv::indx()) -> indx1
        update(arrC1 self, aiv::Istream & S) -> indx1
        update(arrC1 self, arrC1 A) -> indx1
        """
        return _model.arrC1_update(self, *args)

    def load(self, *args):
        """
        load(arrC1 self, aiv::Istream & S, indx1 a=aiv::indx(), indx1 b=aiv::indx(), indx1 step=aiv::indx(1), 
        ...
        load(arrC1 self, aiv::Istream & S, indx1 a=aiv::indx(), indx1 b=aiv::indx(), indx1 step=aiv::indx(1), 
            int * pos=None)
        load(arrC1 self, aiv::Istream & S, indx1 a=aiv::indx(), indx1 b=aiv::indx(), indx1 step=aiv::indx(1))
        load(arrC1 self, aiv::Istream & S, indx1 a=aiv::indx(), indx1 b=aiv::indx())
        load(arrC1 self, aiv::Istream & S, indx1 a=aiv::indx())
        load(arrC1 self, aiv::Istream & S)
        load(arrC1 self, char const * fname, int D2=1, int axe=1-1, int * offset=None, int max=-1, bool write=False)
        load(arrC1 self, char const * fname, int D2=1, int axe=1-1, int * offset=None, int max=-1)
        load(arrC1 self, char const * fname, int D2=1, int axe=1-1, int * offset=None)
        load(arrC1 self, char const * fname, int D2=1, int axe=1-1)
        load(arrC1 self, char const * fname, int D2=1)
        load(arrC1 self, char const * fname)
        """
        return _model.arrC1_load(self, *args)

    def __init__(self, *args): 
        """
        __init__(aiv::array<(cell,1)> self) -> arrC1
        __init__(aiv::array<(cell,1)> self, indx1 AN) -> arrC1
        __init__(aiv::array<(cell,1)> self, indx1 AN, cell Ap) -> arrC1
        __init__(aiv::array<(cell,1)> self, arrC1 A) -> arrC1
        __init__(aiv::array<(cell,1)> self, indx1 AN, char const * fname, int offset, bool write=False) -> arrC1
        __init__(aiv::array<(cell,1)> self, indx1 AN, char const * fname, int offset) -> arrC1
        __init__(aiv::array<(cell,1)> self, aiv::Istream & S, indx1 a=aiv::indx(), indx1 b=aiv::indx(), indx1 step=aiv::indx(1), 
            int * pos=None, int D2=1, int szT=sizeof(cell), long shift_in=-1) -> arrC1
        __init__(aiv::array<(cell,1)> self, aiv::Istream & S, indx1 a=aiv::indx(), indx1 b=aiv::indx(), indx1 step=aiv::indx(1), 
            int * pos=None, int D2=1, int szT=sizeof(cell)) -> arrC1
        __init__(aiv::array<(cell,1)> self, aiv::Istream & S, indx1 a=aiv::indx(), indx1 b=aiv::indx(), indx1 step=aiv::indx(1), 
            int * pos=None, int D2=1) -> arrC1
        __init__(aiv::array<(cell,1)> self, aiv::Istream & S, indx1 a=aiv::indx(), indx1 b=aiv::indx(), indx1 step=aiv::indx(1), 
            int * pos=None) -> arrC1
        __init__(aiv::array<(cell,1)> self, aiv::Istream & S, indx1 a=aiv::indx(), indx1 b=aiv::indx(), indx1 step=aiv::indx(1)) -> arrC1
        __init__(aiv::array<(cell,1)> self, aiv::Istream & S, indx1 a=aiv::indx(), indx1 b=aiv::indx()) -> arrC1
        __init__(aiv::array<(cell,1)> self, aiv::Istream & S, indx1 a=aiv::indx()) -> arrC1
        __init__(aiv::array<(cell,1)> self, aiv::Istream & S) -> arrC1
        __init__(aiv::array<(cell,1)> self, char const * fname, int D2=1, int axe=1-1, int * offset=None, int max=-1, bool write=False) -> arrC1
        __init__(aiv::array<(cell,1)> self, char const * fname, int D2=1, int axe=1-1, int * offset=None, int max=-1) -> arrC1
        __init__(aiv::array<(cell,1)> self, char const * fname, int D2=1, int axe=1-1, int * offset=None) -> arrC1
        __init__(aiv::array<(cell,1)> self, char const * fname, int D2=1, int axe=1-1) -> arrC1
        __init__(aiv::array<(cell,1)> self, char const * fname, int D2=1) -> arrC1
        __init__(aiv::array<(cell,1)> self, char const * fname) -> arrC1
        """
        this = _model.new_arrC1(*args)
        try: self.this.append(this)
        except: self.this = this
    def py_debug_info(self, *args):
        """py_debug_info(arrC1 self, aiv::debug_info & S)"""
        return _model.arrC1_py_debug_info(self, *args)

arrC1_swigregister = _model.arrC1_swigregister
arrC1_swigregister(arrC1)

class meshC1(arrC1):
    """Proxy of C++ aiv::mesh<(cell,1)> class"""
    __swig_setmethods__ = {}
    for _s in [arrC1]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, meshC1, name, value)
    __swig_getmethods__ = {}
    for _s in [arrC1]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
    __getattr__ = lambda self, name: _swig_getattr(self, meshC1, name)
    __repr__ = _swig_repr
    __swig_setmethods__["min"] = _model.meshC1_min_set
    __swig_getmethods__["min"] = _model.meshC1_min_get
    if _newclass:min = _swig_property(_model.meshC1_min_get, _model.meshC1_min_set)
    __swig_setmethods__["max"] = _model.meshC1_max_set
    __swig_getmethods__["max"] = _model.meshC1_max_get
    if _newclass:max = _swig_property(_model.meshC1_max_get, _model.meshC1_max_set)
    __swig_setmethods__["step"] = _model.meshC1_step_set
    __swig_getmethods__["step"] = _model.meshC1_step_get
    if _newclass:step = _swig_property(_model.meshC1_step_get, _model.meshC1_step_set)
    __swig_setmethods__["ext_val"] = _model.meshC1_ext_val_set
    __swig_getmethods__["ext_val"] = _model.meshC1_ext_val_get
    if _newclass:ext_val = _swig_property(_model.meshC1_ext_val_get, _model.meshC1_ext_val_set)
    def info(self, *args):
        """
        info(meshC1 self, aiv::Ostream & S=mystdout)
        info(meshC1 self)
        """
        return _model.meshC1_info(self, *args)

    def copy(self):
        """copy(meshC1 self) -> meshC1"""
        return _model.meshC1_copy(self)

    def crop(self, *args):
        """
        crop(meshC1 self, indx1 a, indx1 b, indx1 istep=aiv::indx(1)) -> meshC1
        crop(meshC1 self, indx1 a, indx1 b) -> meshC1
        crop(meshC1 self, vctr1 a, vctr1 b, indx1 istep=aiv::indx(1)) -> meshC1
        crop(meshC1 self, vctr1 a, vctr1 b) -> meshC1
        """
        return _model.meshC1_crop(self, *args)

    def swap(self, *args):
        """swap(meshC1 self, int i, int j) -> meshC1"""
        return _model.meshC1_swap(self, *args)

    def flip(self, *args):
        """flip(meshC1 self, int i) -> meshC1"""
        return _model.meshC1_flip(self, *args)

    def __getitem__(self, *args):
        """
        __getitem__(meshC1 self, long i) -> cell
        __getitem__(meshC1 self, indx1 I) -> cell
        __getitem__(meshC1 self, PyObject * t) -> cell
        __getitem__(meshC1 self, vctr1 r) -> cell
        """
        return _model.meshC1___getitem__(self, *args)

    def __setitem__(self, *args):
        """
        __setitem__(meshC1 self, long i, cell v)
        __setitem__(meshC1 self, indx1 I, cell v)
        __setitem__(meshC1 self, PyObject * t, cell val)
        __setitem__(meshC1 self, vctr1 r, cell v)
        """
        return _model.meshC1___setitem__(self, *args)

    def __contains__(self, *args):
        """__contains__(meshC1 self, vctr1 r) -> bool"""
        return _model.meshC1___contains__(self, *args)

    def __getstate__(self):
        """__getstate__(meshC1 self) -> PyObject *"""
        return _model.meshC1___getstate__(self)

    def __C_setstate__(self, *args):
        """__C_setstate__(meshC1 self, PyObject * t)"""
        return _model.meshC1___C_setstate__(self, *args)

    def dump(self, *args):
        """
        dump(meshC1 self, aiv::Ostream & S, char const * head=None)
        dump(meshC1 self, aiv::Ostream & S)
        """
        return _model.meshC1_dump(self, *args)

    def load(self, *args):
        """
        load(meshC1 self, aiv::Istream & S, indx1 a=aiv::indx(), indx1 b=aiv::indx(), indx1 step=aiv::indx(1), 
            int * pos=None, int D2=1, int szT=sizeof(cell), long shift_in=-1)
        load(meshC1 self, aiv::Istream & S, indx1 a=aiv::indx(), indx1 b=aiv::indx(), indx1 step=aiv::indx(1), 
            int * pos=None, int D2=1, int szT=sizeof(cell))
        load(meshC1 self, aiv::Istream & S, indx1 a=aiv::indx(), indx1 b=aiv::indx(), indx1 step=aiv::indx(1), 
        ...
        load(meshC1 self, aiv::Istream & S, indx1 a=aiv::indx(), indx1 b=aiv::indx(), indx1 step=aiv::indx(1), 
            int * pos=None)
        load(meshC1 self, aiv::Istream & S, indx1 a=aiv::indx(), indx1 b=aiv::indx(), indx1 step=aiv::indx(1))
        load(meshC1 self, aiv::Istream & S, indx1 a=aiv::indx(), indx1 b=aiv::indx())
        load(meshC1 self, aiv::Istream & S, indx1 a=aiv::indx())
        load(meshC1 self, aiv::Istream & S)
        """
        return _model.meshC1_load(self, *args)

    def __init__(self, *args): 
        """
        __init__(aiv::mesh<(cell,1)> self) -> meshC1
        __init__(aiv::mesh<(cell,1)> self, indx1 AN) -> meshC1
        __init__(aiv::mesh<(cell,1)> self, indx1 AN, vctr1 Amin, vctr1 Amax, cell Ap) -> meshC1
        __init__(aiv::mesh<(cell,1)> self, meshC1 M) -> meshC1
        __init__(aiv::mesh<(cell,1)> self, arrC1 A) -> meshC1
        __init__(aiv::mesh<(cell,1)> self, aiv::Istream & S) -> meshC1
        """
        this = _model.new_meshC1(*args)
        try: self.this.append(this)
        except: self.this = this
    def py_debug_info(self, *args):
        """py_debug_info(meshC1 self, aiv::debug_info & S)"""
        return _model.meshC1_py_debug_info(self, *args)

    __swig_destroy__ = _model.delete_meshC1
    __del__ = lambda self : None;
meshC1_swigregister = _model.meshC1_swigregister
meshC1_swigregister(meshC1)

class mult_arrC1(_object):
    """Proxy of C++ aiv::multiarray<(aiv::array<(cell,1)>)> class"""
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, mult_arrC1, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, mult_arrC1, name)
    __repr__ = _swig_repr
    dim = _model.mult_arrC1_dim
    __swig_setmethods__["N"] = _model.mult_arrC1_N_set
    __swig_getmethods__["N"] = _model.mult_arrC1_N_get
    if _newclass:N = _swig_property(_model.mult_arrC1_N_get, _model.mult_arrC1_N_set)
    __swig_setmethods__["ext_val"] = _model.mult_arrC1_ext_val_set
    __swig_getmethods__["ext_val"] = _model.mult_arrC1_ext_val_get
    if _newclass:ext_val = _swig_property(_model.mult_arrC1_ext_val_get, _model.mult_arrC1_ext_val_set)
    def __init__(self): 
        """__init__(aiv::multiarray<(aiv::array<(cell,1)>)> self) -> mult_arrC1"""
        this = _model.new_mult_arrC1()
        try: self.this.append(this)
        except: self.this = this
    def add_arr(self, *args):
        """add_arr(mult_arrC1 self, indx1 offset, arrC1 arr)"""
        return _model.mult_arrC1_add_arr(self, *args)

    def dump(self, *args):
        """
        dump(mult_arrC1 self, aiv::Ostream & S, char const * header=None)
        dump(mult_arrC1 self, aiv::Ostream & S)
        """
        return _model.mult_arrC1_dump(self, *args)

    def load(self, *args):
        """load(mult_arrC1 self, aiv::Istream & S)"""
        return _model.mult_arrC1_load(self, *args)

    def __len__(self):
        """__len__(mult_arrC1 self) -> int"""
        return _model.mult_arrC1___len__(self)

    def __getitem__(self, *args):
        """
        __getitem__(mult_arrC1 self, indx1 I) -> cell
        __getitem__(mult_arrC1 self, long I) -> cell
        """
        return _model.mult_arrC1___getitem__(self, *args)

    def __setitem__(self, *args):
        """
        __setitem__(mult_arrC1 self, indx1 I, cell val)
        __setitem__(mult_arrC1 self, long I, cell val)
        """
        return _model.mult_arrC1___setitem__(self, *args)

    __swig_destroy__ = _model.delete_mult_arrC1
    __del__ = lambda self : None;
mult_arrC1_swigregister = _model.mult_arrC1_swigregister
mult_arrC1_swigregister(mult_arrC1)

arrC1.__setstate__, meshC1.__setstate__ = _setstate, _setstate 
