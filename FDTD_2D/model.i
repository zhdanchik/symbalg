...
%include "aivlib/meshTD.hpp"
%include "aivlib/multiarrayT.hpp"
%template(arrC2) aiv::array<cell,2>; %template(meshC2) aiv::mesh<cell,2>; %template(mult_arrC2) aiv::multiarray< aiv::array<cell,2> >;
%pythoncode %{arrC2.__setstate__, meshC2.__setstate__ = _setstate, _setstate %}
%template(splice1) aiv::splice<1,cell,2>;
%pythoncode %{from aivlib.vctr2 import * %}
